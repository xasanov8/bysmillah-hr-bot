...
const STRINGS = {
  uz: {
    ...
    errorTextAuth: 'Sessiya muddati tugadi. Formani yopib, botdan qaytadan oching — javoblaringiz saqlanib qoladi.',
    errorTextServer: 'Texnik nosozlik yuz berdi. Bir necha daqiqadan so‘ng qayta urinib ko‘ring.',
    errorTextCv: 'Rezyume yuklanmadi. PDF, DOC, DOCX, RTF, ODT yoki TXT faylni (15 MB gacha) tanlang.',
    retry: 'Qayta urinish',
  ...
  ru: {
    ...
    errorTextAuth: 'Сессия истекла. Закройте форму и откройте её заново из бота.',
    errorTextServer: 'Техническая ошибка. Попробуйте через несколько минут.',
    errorTextCv: 'Резюме не загрузилось. Выберите файл PDF, DOC, DOCX, RTF, ODT или TXT до 15 МБ.',
    retry: 'Повторить',
  ...
  en: {
    ...
    errorTextAuth: 'Your session has expired. Close the form and open it again from the bot — your answers are kept.',
    errorTextServer: 'Something went wrong on our side. Please try again in a few minutes.',
    errorTextCv: 'The resume was not accepted. Please attach a PDF, DOC, DOCX, RTF, ODT or TXT file up to 15 MB.',
    retry: 'Try again',
